...
export interface Entity {
  ...
  spawnPos?: Vec2;
  spawnRadius?: number;
  // Bioma di appartenenza del mostro: se presente, il mostro puo' vagare e
  // rincorrere bersagli SOLO dentro questo bioma (usa inZone), invece di
  // essere limitato al piccolo cerchio spawnPos/spawnRadius. Vedi engine.ts:
  // updateEnemy.
  spawnBiome?: BiomeId;
